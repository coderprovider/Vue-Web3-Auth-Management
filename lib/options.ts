...
export function setOptions(newOptions: Options | {}): void {
  ...
  if ('web3modalOptions' in newOptions) {
    // @ts-ignore
    if ('themeMode' in newOptions.web3modalOptions) {
      // @ts-ignore
      state.web3modalOptions.themeMode = newOptions.web3modalOptions.themeMode
    }

    // @ts-ignore
    if ('themeVariables' in newOptions.web3modalOptions) {
      // @ts-ignore
      state.web3modalOptions.themeVariables = newOptions.web3modalOptions.themeVariables
    }
  }
}
